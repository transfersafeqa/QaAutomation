 ...
 */
    ...
    public DemoGraphicInfoPage coBorrowerDemographics() throws Exception{
        ...
        driver.findElement(By.xpath("//label[@for='primary_question_3']")).click();
        Thread.sleep(4000);
        driver.findElement(By.xpath("//label[contains(@for,'co_question_1_answer_2')]")).click();
        Thread.sleep(4000);
        driver.findElement(By.xpath("//label[@for='co_question_2']")).click();
        Thread.sleep(4000);
        driver.findElement(By.xpath("//label[@for='co_question_3']")).click();
